...
public class CatalogosController {
    ...
    @Operation(summary = "Obtener lista de Periodos para un tipo de Reporte", description = "Obtener lista de Periodos para un tipo de Reporte")
    @GetMapping("periodos/{idTipoReporte}")
    @ResponseBody
    public ResponseEntity<List<PeriodosReporteResponse>> getLisPeriodosReporte(@PathVariable int idTipoReporte){
        List<PeriodosReporteResponse> result = catalogoServices.getListPeriodosByReport(String.valueOf(idTipoReporte));
