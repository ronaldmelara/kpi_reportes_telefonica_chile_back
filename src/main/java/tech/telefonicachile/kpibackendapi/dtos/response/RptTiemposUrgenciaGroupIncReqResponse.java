...
@Data
@Builder
public class RptTiemposUrgenciaGroupIncReqResponse {
    int idGrupoAsignado;
    ...
    public RptTiemposUrgenciaGroupIncReqResponse(int idGrupoAsignado, String grupoAsignado, Integer idUrgencia, String urgencia, java.sql.Time promedioIncidentes, java.sql.Time promedioRequerimientos, java.sql.Time promedioTotal, BigDecimal minInc, BigDecimal minReq) {
